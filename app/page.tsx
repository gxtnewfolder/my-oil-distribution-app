    ...
    <div className="container mx-auto p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          >
            <Link href="/financial-reports/inventory-stock-card">View Inventory Details</Link>
      ...
      <div className="prose">
        ...
        <p>
          TATA co. is a leading oil distribution center providing reliable and
          efficient fuel delivery services to our valued customers. With
          state-of-the-art facilities and a dedicated team, we ensure the timely
          and secure distribution of petroleum products across the region.
        </p>
        <p>
          Our commitment to quality, safety, and customer satisfaction sets us
          apart. We offer a wide range of fuels, including gasoline, diesel, and
          aviation fuel, catering to diverse industries and needs.
        </p>
        <p>
          To learn more about our services, explore our financial reports, or
          contact us for inquiries, please use the navigation menu on the left.
        </p>
      </div>
    </div>
  );
